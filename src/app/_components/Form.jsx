          ...
          <div className="max-w-sm mx-auto-3 py-3 space-y-3 text-center">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              <div className="relative mt-3">
                <input type="text" placeholder="reciever" onChange={(e) => setShipment({...shipment, reciever: e.target.value,})} className="w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg" />
              </div>
              <div className="relative mt-3">
